...
!function ($) {
    ...
    BootstrapTable.prototype.onSearch = function (event) {
		...
		this.scolumnText=$('#sel_column').val();
    ...
    BootstrapTable.prototype.initServer = function (silent, query) {
        var that = this,
            data = {},
            params = {
				scolumnText:this.scolumnText==undefined?'':this.scolumnText,
                searchText: this.searchText==undefined?'':this.searchText,
                sortName: this.options.sortName==undefined?'':this.options.sortName,
