...
public class GraduationDTO {
    ...
    /**学院代码*/
    @Excel(name = "学院代码",width=20)
    private String departCode;
    /**专业*/
    @Excel(name = "专业",width=20)
    private String major;
    /**专业代码*/
    @Excel(name = "专业代码",width=20)
    private String majorCode;
    /**学生人数*/
    @Excel(name = "学生人数",width=20)
    private int count;
    /**学生总数*/
    @Excel(name = "学生总数",width=20)
    private int total;
    /**签三方*/
    @Excel(name = "签三方",width=20)
    private int agreement;
    /**签合同*/
    @Excel(name = "签合同",width=20)
    private int contract;
    /**在职*/
    @Excel(name = "在职",width=20)
    private int incumbent;
    /**升学*/
    @Excel(name = "升学",width=20)
    private int relearning;
    /**签约合计*/
    @Excel(name = "签约合计",width=20)
    private int signings;
    /**签约率*/
    @Excel(name = "签约率",width=20)
    private double signrate;
    /**出国*/
    @Excel(name = "出国",width=20)
    private int abroad;
    /**单位证明*/
    @Excel(name = "单位证明",width=20)
    private int certificate;
    /**自由职业*/
    @Excel(name = "自由职业",width=20)
    private int liberal;
    /**自主创业*/
    @Excel(name = "自主创业",width=20)
    private int selfemployed;
    /**签约中*/
    @Excel(name = "签约中",width=20)
    private int signing;
    /**就业合计*/
    @Excel(name = "就业合计",width=20)
    private int employs;
    /**就业率*/
    @Excel(name = "就业率",width=20)
    private double employrate;
    /**求职中*/
    @Excel(name = "求职中",width=20)
    private int intention;
    /**拟参加公招考试*/
    @Excel(name = "拟参加公招考试",width=20)
    private int officer;
    /**其他求职中*/
    @Excel(name = "其他求职中",width=20)
    private int other;
    /**拟创业*/
    @Excel(name = "拟创业",width=20)
    private int work;
    /**暂不就业*/
    @Excel(name = "暂不就业",width=20)
    private int unemploy;
    /**拟升学*/
    @Excel(name = "拟升学",width=20)
    private int inrelearning;
    /**拟出国出境*/
    @Excel(name = "拟出国出境",width=20)
    private int inabroad;
    /**未就业合计*/
    @Excel(name = "未就业合计",width=20)
    private int unemploys;
    /**未就业率*/
    @Excel(name = "未就业率",width=20)
    private double unemployrate;
    /**总签约率*/
    @Excel(name = "总签约率",width=20)
    private double allsignrate;
    /**总就业率*/
    @Excel(name = "总就业率",width=20)
    private double allemployrate;
    /**总未就业率*/
    @Excel(name = "总未就业率",width=20)
    private double allunemployrate;
    /**添加时间*/
    @Excel(name = "添加时间",width=20)
    ...
    public String toString(){
        StringBuilder strBuf = new StringBuilder("GraduationDTO{\n");
