...
public class WeChatMpConfig {
    ...
    public WxMpConfigStorage wxMpConfigStorage() {
        ...
        ((WxMpInMemoryConfigStorage) wxMpConfigStorage).setToken(wechatAccountConfig.getMpAppToken());
        ((WxMpInMemoryConfigStorage) wxMpConfigStorage).setAesKey(wechatAccountConfig.getMpAppAesKey());
