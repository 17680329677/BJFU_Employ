package com.yuan.generatorcode.core;

import com.yuan.generatorcode.bean.*;
...
import com.yuan.generatorcode.database.DatabaseReaderFactory;
import com.yuan.generatorcode.util.ConfigUtil;
...
//                        BufferedWriter osw = new BufferedWriter(new FileWriter(outFile));
    ...
    private List<GeneratorColumnInfo> buildGeneratorColumnInfos(List<ColumnInfo> columnsInfo) {
        ...
        for (int i = 0; i < columnsInfo.size(); i++) {
            ...
            JavaType javaType = dbReader.dbTypeCoverToJavaType(columnInfo.getDataType(), columnInfo.getColumnType());
    ...
    /**
     * 构建DatabaseInfoReader
     */
    private void buildDatabaseInfoReader() {
        dbReader = DatabaseReaderFactory.getDatabaseInfoReader(databaseConfig.getDbType());
    }
